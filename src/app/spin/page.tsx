...
export default function SpinPage() {
  ...
  const loadUserSpins = async () => {
    try {
      ...
      // Check if phone number was already submitted today
  ...
  const handlePhoneSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!existingPhone) {
        ...
        // Grant additional spin and mark as submitted
        setSpinsRemaining(1);
  ...
  const spinWheel = async () => {
    ...
    try {
      ...
      // Add half a slice to ensure pointer lands in center of section
      ...
      // Record spin time and update remaining spins
